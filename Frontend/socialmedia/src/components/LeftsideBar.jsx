  ...
  return (
    ...
    {/* Section1 */}
      ...
      <p className='font-semibold text-lg font-sans'>Explore</p>
        ...
        <Link className='font-sans px-1 font-semibold hover:text-blue-950' to='/home'>Home</Link>
        </div>
        {/* Profile */}
        <div className='inline-flex items-center space-x-1 py-2'>
          <img className='rounded-full w-5 h-5' src={user?.profile_image ||"https://i.pinimg.com/736x/58/51/2e/58512eb4e598b5ea4e2414e3c115bef9.jpg"} alt="User Profile" />
            <Link className='px-1 font-sans font-semibold hover:text-blue-950' to='/profile'>Profile</Link>
        </div>
      </div>
      ...
      <div className='py-3 flex flex-col items-start'>
        ...
        <div className='inline-flex items-center space-x-1 py-2'>
            ...
            <p className='font-semibold font-sans px-1'>Friends</p>
        </div>
        {/* Messages */}
        <div className='inline-flex items-center space-x-1 py-2'>
            ...
            <p className='font-semibold font-sans px-1'>Messages</p>
        </div>
      </div>
    </div>
      {/* Section 3 LogOut */}
      ...
      <div className='my-3'>
        <button onClick={onhandlelogout} className='p-2 bg-blue-800 text-white text-sm rounded-2xl'>Logout</button>
      </div>
    </div>
  )
}
