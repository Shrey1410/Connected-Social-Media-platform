    ...
    <div>
      <div className='bg-white p-4 rounded-2xl my-4'>
        {/* User who posted */}
            ...
            <img className='rounded-full w-10 h-10' src={post?.createdBy.profile_image || "https://static.thenounproject.com/png/3874124-200.png"} alt="User Profile" />
            <Link className='px-3 font-semibold font-sans' to='/userprofile'
        state={{ user: post?.createdBy }}>{post?.createdBy.fullname}</Link>
        ...
        {props?.post?.post_image &&
            <div className="my-2 w-auto max-h-80 overflow-auto rounded-xl">
            <img
            src={post.post_image}
